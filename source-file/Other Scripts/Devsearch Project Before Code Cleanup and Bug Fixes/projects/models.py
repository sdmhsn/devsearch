...
class Project(models.Model):
    ...
    class Meta:
        # ordering = ['-created']  # selain menggunakan queryset API .order_by('-created'), dapat juga menggunakan seperti ini pada models.py. tanda minus pada '-created' untuk menampilkan dari belakang (terbaru)
