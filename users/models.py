...
class Profile(models.Model):
    ...
    # class Meta:  # we can alse handle this sorting by queryset API in utils.py
    #     ordering = ['created']
    
    @property  # to avoid the error when some reason user deleted the project Image/Picture on clear checked button Featured image in Profiles django admin
    def imageURL(self):
        try:
