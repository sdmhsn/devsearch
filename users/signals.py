...
def deleteProfile(sender, instance, **kwargs):
    try:  # to avoid an error / issue when we delete any user on Users Django Admin
        user = instance.user  # instance.user related to Profile.user
        print('Delete on Profiles:', instance)  # delete on Profiles
        user.delete()
    except:
        print('Delete on Users:', instance)  # delete on Users
        pass  # pass the error when we delete any user on Users Django Admin. so it will except the delete of user that we want
